...
// Fonts
			...
			$typography_mixed_fonts = array_merge(options_typography_get_os_fonts() , options_typography_get_google_fonts());
			 $typography_mixed_fonts["'Helvetica Neue', Helvetica, Arial, sans-serif"] = 'Helvetica Neue *';
...
// ---------------------------------------------------------
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '18px', 'lineheight' => '29px', 'face' => "'Helvetica Neue', Helvetica, Arial, sans-serif", 'style' => 'normal', 'character'  => 'latin', 'color' => '#393939'));

			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '66px', 'lineheight' => '80px', 'face' => "'Helvetica Neue', Helvetica, Arial, sans-serif", 'style' => 'normal', 'character'  => 'latin', 'color' => '#202020'));

			$options['h2_heading'] = array(
								'id' => 'h2_heading',
								'std' => array( 'size' => '46px', 'lineheight' => '57px', 'face' => "'Helvetica Neue', Helvetica, Arial, sans-serif", 'style' => 'normal', 'character'  => 'latin', 'color' => '#202020'));

			$options['h3_heading'] = array(
								'id' => 'h3_heading',
								'std' => array( 'size' => '40px', 'lineheight' => '46px', 'face' => "'Helvetica Neue', Helvetica, Arial, sans-serif", 'style' => 'normal', 'character'  => 'latin', 'color' => '#202020'));

			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '30px', 'lineheight' => '48px', 'face' => "'Helvetica Neue', Helvetica, Arial, sans-serif", 'style' => 'normal', 'character'  => 'latin', 'color' => '#202020'));

			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '28px', 'lineheight' => '40px', 'face' => "'Helvetica Neue', Helvetica, Arial, sans-serif", 'style' => 'normal', 'character'  => 'latin', 'color' => '#202020'));

			$options['h6_heading'] = array(
								'id' => 'h6_heading',
								'std' => array( 'size' => '25px', 'lineheight' => '30px', 'face' => "'Helvetica Neue', Helvetica, Arial, sans-serif", 'style' => 'normal', 'character'  => 'latin', 'color' => '#202020'));
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '18px', 'lineheight' => '24px', 'face' => "'Helvetica Neue', Helvetica, Arial, sans-serif", 'style' => 'bold', 'character'  => 'latin', 'color' => '#ffffff'));
...
// ---------------------------------------------------------
			...
			$options['menu_typography'] = array(
								'id' => 'menu_typography',
								'std' => array( 'size' => '18px', 'lineheight' => '29px', 'face' => "'Helvetica Neue', Helvetica, Arial, sans-serif", 'style' => 'normal', 'character'  => 'latin', 'color' => '#ffffff'));
...
// ---------------------------------------------------------
			...
			$options['footer_menu_typography'] = array(
								...
								'std' => array( 'size' => '15px', 'lineheight' => '24px', 'face' => "'Helvetica Neue', Helvetica, Arial, sans-serif", 'style' => 'normal', 'character'  => 'latin', 'color' => '#ffffff'));
		return $options;
	}
}
?>
